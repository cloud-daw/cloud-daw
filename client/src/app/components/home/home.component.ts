import { Component, Output, EventEmitter, HostListener, ViewEncapsulation, SimpleChanges, Input, ViewChild, ViewChildren, QueryList, OnInit, OnDestroy } from '@angular/core';
...
;    @ViewChildren('blockRef') blockRefs?: QueryList<MidiBlockComponent>;
    ...
    constructor(public firebaseService: FirebaseService, public ApiHttpService: ApiHttpService, public _router: Router, public messengerService: MessengerService) {
